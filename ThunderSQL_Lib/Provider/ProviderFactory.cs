...
using System.Linq;
using ThunderSQL.Provider.Common;

namespace ThunderSQL.Provider
{
    public class ProviderFactory
    {
        ...
        public IDataProvider ResolveDataProvider(string providerName)
        {
            ...
            var exceptionMessage = String.Format(
                "ThunderSQL do not supports the '{0}' provider. Either add your provider using the ProviderFactory.AddProvider() method, or create and set a ProviderResolver.CustomProvider.",
                providerName);
